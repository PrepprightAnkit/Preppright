      ...
      return (
        <div className="bg-gradient-to-br from-primary-light to-white pt-0 py-16 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto max-w-7xl">
            {/* Header Section */}
            <div className="h-max bg-white rounded-2xl shadow-lg p-8 mb-8 relative">
              <div>
                ...
                <p className="text-xl text-gray-600 leading-relaxed mb-6">
                  ...
                  expert insights tailored to your unique path.
                </p>
              {/* Image Below Text */}
              <div className="w-full">
                <img 
                  ...
                  className=" -mt-44 -md-10 w-full h-auto object-contain"
                />
              </div>
