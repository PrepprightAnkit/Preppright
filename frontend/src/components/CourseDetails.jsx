  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-blue-50 to-blue-100 min-h-screen py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Comprehensive curriculum designed to transform you into a skilled {course.courseType} professional
            </p>
          </div>
          ...
          {course.syllabus.map((section, index) => (
            <div 
              key={index} 
              className="bg-white border border-gray-200 rounded-xl overflow-hidden mb-4 shadow-sm transition-all duration-300 hover:shadow-md"
            >
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {course.courseProjects.map((project, index) => (
            <div 
              key={index} 
              className="bg-white border border-gray-200 rounded-xl p-8 hover:shadow-lg transition-transform hover:scale-105"
            >
