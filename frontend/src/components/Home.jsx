            ...
            <nav className="bg-white p-4">
                <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-4">
                        <button className="bg-blue-500 hover:bg-blue-900 text-white px-4 py-2 rounded-full">Login</button>
                        <button className="bg-green-500 hover:bg-green-900 text-white px-4 py-2 rounded-full">Register</button>
                    </div>
                </div>
            </nav>
